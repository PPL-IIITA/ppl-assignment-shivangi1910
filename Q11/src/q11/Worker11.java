...
//                    System.out.print(girls.get(i).gethas_bf()+ " ");
                ...
                if (f == 0) {
                    try {
                        Timestamp TS = new Timestamp(System.currentTimeMillis());
                        w.println(TS + " Exception: Girl " + i + " doesn't get a boyfriend");

                        throw new BfNotFound("Girl " + i + " doesn't get a boyfriend");//k+"couples");
                    } catch (BfNotFound ex) {
                        System.out.println();
...
//                    System.out.print(girls.get(i).gethas_bf()+ " ");
                ...
                if (f == 0) {
                    try {
                        Timestamp TS = new Timestamp(System.currentTimeMillis());
                        w.println(TS + " Exception: Boy " + j + " doesn't get a girlfriend");

                        throw new GfNotFound("Boy " + j + " doesn't get a girlfriend");//k+"couples");
                    } catch (GfNotFound ex) {
                        System.out.println();
                        System.out.println(ex);
    ...
    void printkcouples(PrintWriter w) throws FileNotFoundException {
        ...
        if (k > couples.size()) {
            try {
                Timestamp TS = new Timestamp(System.currentTimeMillis());
                w.println(TS + " Exception: Less than " + k + " couples formed");

                throw new LessCouplesFormed("less than " + k + " couples formed");//k+"couples");
            } catch (LessCouplesFormed ex) {
                System.out.println();
                System.out.println(ex);
                k = couples.size();
            }
    ...
    void breakup(PrintWriter w) throws FileNotFoundException {
...
//                    System.out.print(girls.get(i).gethas_bf()+ " ");
    ...
    void find_boys(PrintWriter w, int k) throws FileNotFoundException {
        ...
        if (k <= 0) {
            try {
                Timestamp TS = new Timestamp(System.currentTimeMillis());
                w.println(TS + " Exception: Invalid k ");

                throw new InvalidK(" Exception: Invalid k ");
            } catch (InvalidK ex) {
                System.out.println();
                System.out.println(ex);
        ...
        if (k > 3) {
            try {
                Timestamp TS = new Timestamp(System.currentTimeMillis());
                w.println(TS + " Exception: k Out of Bounds");

                throw new InvalidK(" Exception: k Out of Bounds ");
            } catch (InvalidK ex) {
                System.out.println();
                System.out.println(ex);
